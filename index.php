...
<body>
  ...
  <header class="main-header">
    <img class="head-img" src="./images/headf.jpg" />
    <div class="top-left">
      <h1><strong>Ready to Export</strong></h1>
      <p>

        AutoExport are a global car exporter, specialising in
      ...
      <div class="second-section">
        ...
        <div class="second4">
          <h4><img src="./images/usp-icon-star.svg" width="30" height="30">Vat qualifying cars</h4>
          <p>
            Vat qualifying cars - we specialise in vat qualifying prestige
            vehicles
          </p>
        </div>
      </div>
    ...
    <div class="row mt-4 pb-4 pt-2 slider">
      ...
      <div class="col-5">
        <div class="card card-block card-2">
          <img width="400" height="500" src="./images/NODE 4.jpg">
          <p class="centered">
            <b> Honda Vezel</b>
          </p>
        </div>
  ...
  <div class="third-section">
    <div class="third1"><img class="box-img" src="./images/next node 1.jpg"></div>
    <div class="third2"><img class="box-img" src="./images/next node 2.jpg"></div>
    <div class="third3"><img class="box-img" src="./images/next node 3.jpg"></div>
  ...
  <div class="forth">
    <div class="about-us">
      ...
      <p>
        AutoExport has traded in various aspects of the Motor Industry <br />over
        ...
        suppliers, manufacturers and freight<br /> forwarding companies.
      </p>
    </div>
    <div class="testimonals">
      <h1><b><br />Testimonals</b></h1>
      <p>I will only use MMSALES for importing my vehicles. No one else.</p>
    </div>
  </div>

  <div class="fifth">
    <img class="getintouch" src="./images/get in touch.jpg">
  ...
  <div class="sixth">
    <div class="box-1"><img class="box-img" src="./images/4div.jpg">
