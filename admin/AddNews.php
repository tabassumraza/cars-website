...
<body>
    ...
    <form method="post" class="w-50 bg-dark p-3 mx-auto" enctype="multipart/form-data">
        <h1 class="text-light text-center mb-5">ADD A CAR NEWS .</h1>
        <input type="text" placeholder="Enter name of the car" name="carname" class="form-control"><br>
        <input type="text" placeholder="Enter short description" name="cardes" class="form-control"><br>
    ...
    <?php
        if(isset($_POST['submit'])){
            ...
            $insert = "INSERT INTO `news`(`c_name`,`c_des`, `n_image`) VALUES ('$carname','$cardes','$n_image')";
